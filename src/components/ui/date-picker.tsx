  ...
  return (
    <div className={cn('relative', className)} ref={pickerRef}>
      ...
      <button
        ...
        className={cn(
          "relative w-full pl-10 pr-4 py-2 bg-card border border-border rounded-lg text-foreground text-sm",
          "hover:border-border/80 transition-colors min-w-[150px] text-left",
